...
class Main {
	static main() {
		...
		if(runTests) {
			...
			actions_Core.endGroup();
			let code = Command.runAllNamed(Tests.make(target));
			process.exit(code);
		}
	}
	...
	static installHaxelibs(flixelVersions) {
		...
		let lib11 = "lime";
		let libs = [function() {
			return Haxelib.install(lib);
		},function() {
			return Haxelib.install(lib1);
		},function() {
			return Haxelib.install(lib2);
		},function() {
			return Haxelib.install(lib3);
		},function() {
			return Haxelib.install(lib4);
		},function() {
			return Haxelib.install(lib5);
		},function() {
			return Haxelib.git(user,lib6);
		},function() {
			return Haxelib.git(user1,lib7);
		},function() {
			return Haxelib.git(user2,lib8);
		},function() {
			return Haxelib.git(user3,lib9);
		},function() {
			return Haxelib.install(lib10);
		},function() {
			return Haxelib.install(lib11);
		}];
		let libs1;
		if(flixelVersions == "dev") {
			...
			let lib5 = "flixel-ui";
			libs1 = [function() {
				return Haxelib.git(user,lib);
			},function() {
				return Haxelib.git(user1,lib1);
			},function() {
				return Haxelib.git(user2,lib2);
			},function() {
				return Haxelib.git(user3,lib3);
			},function() {
				return Haxelib.git(user4,lib4);
			},function() {
				return Haxelib.git(user5,lib5);
			}];
		} else {
			let lib = "flixel";
			let lib1 = "flixel-tools";
	...
	static installHxcpp(target) {
		...
		let hxcppDir = haxe_io_Path.join([Main.HaxelibRepo,"hxcpp/git/"]);
		let user = "HaxeFoundation";
		let lib = "hxcpp";
		...
		return Command.runAll([function() {
			...
			return Command.runInDir(dir,cmd,args);
		},function() {
			return Command.runInDir(dir1,cmd1,args1);
		}]);
	}
}
Main.__name__ = true;
...
class Tests {
	static make(target) {
		...
		let target4 = target;
		let demos = target == "cpp" ? Tests.ImportantDemos : [];
		let tmp3 = function() {
	...
	static buildCoverageTests(target) {
		...
		return Command.runAll([function() {
			return OpenFL.build(path,target1,define);
		},function() {
			return OpenFL.build(path1,target2,define1);
		}]);
	}
	...
	static buildSwfVersionTests(target) {
		...
		let target2 = target;
		return Command.runAll([function() {
			return OpenFL.build(path,target1);
		},function() {
			return OpenFL.build(path1,target2);
		}]);
	}
}
Tests.__name__ = true;
